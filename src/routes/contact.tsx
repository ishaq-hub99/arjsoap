...
const copy = {
  ...
  am: {
    head: {
      title: "አርጂ ሳሙና ዲተርጀንት እና ማምረቻን ያግኙ | ሰበታ፣ ኢትዮጵያ",
      description:
        "አርጂ ሳሙና ዲተርጀንት እና ማምረቻን በሰበታ፣ ኢትዮጵያ ያግኙ። ለAMARD እና ADWA የልብስ ማጠቢያ ሳሙና ጥያቄዎች በ+251 911 314 758 ወይም +251 911 235 104 ይደውሉ።",
    },
    hero: {
      eyebrow: "አግኙን",
      title: "ከአርጂ ጋር ይገናኙ",
      description:
        "ስለ ትዕዛዞች፣ ስርጭት ወይም ስለ AMARD እና ADWA የልብስ ማጠቢያ ሳሙና ጥያቄዎች ለማንኛውም በሰበታ፣ ኢትዮጵያ የሚገኘውን ቡድናችንን ያግኙ።",
    },
    details: {
      eyebrow: "የድርጅት መረጃ",
      title: "አርጂ ሳሙና ዲተርጀንት እና ማምረቻ",
      location: { label: "አድራሻ", value: "ሰበታ፣ ኢትዮጵያ", helper: "ለፋብሪካው አድራሻ ከዚህ በታች ያለውን ካርታ ይመልከቱ።" },
      phone: { label: "ስልክ" },
      email: { label: "ኢሜይል", value: "የኢሜይል አድራሻ በአርጂ ይታከላል።" },
    },
    form: {
      title: "መልዕክት ይላኩልን",
      subtitle: "ቅፁን ይሙሉ፤ ቡድናችን መልስ ይሰጥዎታል።",
      fields: {
      ...
      submit: "መልዕክት ላክ",
      success:
        "እናመሰግናለን — መልዕክትዎ ተመዝግቧል። ጉዳዩ አስቸኳይ ከሆነ እባክዎ ከላይ በተጠቀሱት ስልክ ቁጥሮች ደውለው ያነጋግሩን።",
      errors: {
        ...
        emailMax: "ኢሜይሉ በጣም ረዥም ነው",
        messageMin: "እባክዎ አጭር መልዕክት ይፃፉ",
    ...
    map: {
      eyebrow: "ያግኙን",
      title: "አርጂ ሳሙና ዲተርጀንት እና ማምረቻ",
      description: "ሰበታ፣ ኢትዮጵያ። ወደ ፋብሪካችን አቅጣጫ ለማግኘት ከዚህ በታች ያለውን ካርታ ይጠቀሙ።",
      iframeTitle: "የአርጂ ሳሙና ዲተርጀንት እና ማምረቻ ካርታ፣ ሰበታ፣ ኢትዮጵያ",
