...
const copy = {
  ...
  am: {
    hero: {
      eyebrow: "ብራንዶቻችን",
      title: "አማርድ የልብስ ሳሙና እና አድዋ የልብስ ሳሙና",
      description:
        "ኤ.አር.ጄ ሳሙና፣ ዲተርጀንት እና ማምረቻ በሰበታ፣ ኢትዮጵያ በሚገኘው ፋብሪካው የሚያመርታቸው ሁለት የልብስ ሳሙና ብራንዶች።",
    },
    manufacturedBy: "በኤ.አር.ጄ ሳሙና፣ ዲተርጀንት እና ማምረቻ የተመረተ",
    gallery: {
      eyebrow: "አድዋ — ለንጽህና ድል",
      title: "አድዋ በዕለት ተዕለት ልብስ ማጠብ",
      description: "በሰበታ፣ ኢትዮጵያ በሚገኘው የኤ.አር.ጄ ፋብሪካ የሚመረቱ የአድዋ የልብስ ሳሙና ብሎኮች።",
      photos: [
        { alt: "የአድዋ የልብስ ሳሙና በእንጨት ማጠቢያ ሰሌዳ ላይ ውሃ ሲፈስስበት" },
        { alt: "ቢጫ የአድዋ የልብስ ሳሙና በማጠቢያ ሰሌዳ ላይ ከታጠፉ ፎጣዎች አጠገብ" },
        { alt: "የአድዋ የልብስ ሳሙና በነጭ የታጠፉ ፎጣዎች ላይ ተቀምጦ" },
        { alt: "የአድዋ የልብስ ሳሙና በእምነበረድ ሰሌዳ ላይ ከታጠቡ ነጭ ልብሶች ፊት ለፊት" },
      ],
    },
    oneManufacturer: {
      eyebrow: "አንድ አምራች",
      ...
      description:
        "አማርድ እና አድዋ በሰበታ፣ ኢትዮጵያ በሚገኘው የኤ.አር.ጄ ፋብሪካ ተመሳሳይ የማምረቻ ደረጃ፣ ዘመናዊ ማሽነሪ እና የጥራት ትኩረት ይጋራሉ።",
    },
