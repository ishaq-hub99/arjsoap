...
const copy = {
  ...
  am: {
    hero: {
      ...
      title: "የማምረቻ ፋብሪካችን",
      description:
        "ኤ.አር.ጄ ሳሙና፣ ዲተርጀንት እና ማምረቻ በሰበታ፣ ኢትዮጵያ የሚገኝ፣ ከቻይና በገቡ ዘመናዊ ማሽነሪዎች የተደራጀ ራሱን የቻለ ማምረቻ ፋብሪካ ይዞ ይሠራል።",
    },
    packagingAlt: "የአድዋ የልብስ ሳሙና ብራንድ ማሸጊያ ፊልም በኤ.አር.ጄ ፋብሪካ የማሸጊያ ማሽን ውስጥ ሲያልፍ",
    sections: [
      {
        title: "ስለ ፋብሪካችን",
        body: "ኤ.አር.ጄ በሰበታ፣ ኢትዮጵያ ራሱን የቻለ ማምረቻ ፋብሪካ ያንቀሳቅሳል፤ በዚህ ፋብሪካ አማርድ እና አድዋ ጠንካራ የልብስ ማጠቢያ ሳሙናዎች ይመረታሉ።",
      },
      {
        title: "ዘመናዊ ማሽነሪ",
    ...
    headDescription:
      "በኤ.አር.ጄ ማምረቻ ፋብሪካ ውስጥ በሰበታ፣ ኢትዮጵያ፡ ከቻይና የገቡ ዘመናዊ ማሽነሪዎች፣ ምርት፣ ማሸግ፣ ማከማቻ እና ስርጭት።",
  },
