...
const copy = {
  ...
  am: {
    ...
    meaning: {
      eyebrow: "ይህ ማለት ምን ማለት ነው",
      title: "ቅድሚያ ለጥራት፣ ቀጥሎ ለብራንድ",
      description:
        "ራዕያችን የሚጀምረው ከራሱ ከሳሙናው ነው። አማርድ እና አድዋ ዘላቂ፣ በደንብ የሚያረጋግጡና ለቆዳ ገር እንዲሆኑ በማድረግ፣ ከሰበታና ከኢትዮጵያ ውጪ ለማደግ የሚያስፈልገንን እምነት እንገነባለን።",
    },
    items: [
      { title: "ወጥነት ያለው ምርት", body: "ከፋብሪካው የሚወጣ እያንዳንዱ ካርቶን ከቀድሞው ጋር ተመሳሳይ ጥራት ሊኖረው ይገባል።" },
      {
        title: "ተለይተው የሚታወቁ ብራንዶች",
        body: "ደንበኞች ወዲያውኑ ሊለዩት የሚችሉት ንፁህና ማራኪ ማሸጊያ።",
      },
      { title: "አስተማማኝ አቅርቦት", body: "ለስርጭት ዝግጁ የሆነ የምርት ክምችት ሁሌም በፋብሪካው ውስጥ ይያዛል።" },
    ],
    alt: "በኤ.አር.ጄ የተመረተ የአድዋ የልብስ ሳሙና ማሸጊያ",
    head: {
      title: "ራዕያችን | በአፍሪካ ቁጥር አንድ የሳሙና ብራንድ መሆን",
      description:
        "የኤ.አር.ጄ ሳሙና፣ ዲተርጀንት እና ማምረቻ ራዕይ በአፍሪካ ቁጥር አንድ የሳሙና ብራንድ መሆን ሲሆን፣ በሰበታ፣ ኢትዮጵያ በሚመረት ጥራት ያለው የልብስ ማጠቢያ ሳሙና ላይ የተመሰረተ ነው።",
    },
  },
